...
class OneDriveGeminiAssistant:
        ...
        try:
            ...
            try:
                ...
                if search_data and 'value' in search_data:
                    ...
                    print("⚠️ Search endpoint returned no data")
            except Exception as e:
            ...
            try:
                ...
                print(f"⚠️ Recursive method failed: {e}")
            ...
            try:
                ...
                if root_data and 'value' in root_data:
                    ...
                    print("⚠️ Root children endpoint returned no data")
            except Exception as e:
                print(f"⚠️ Root children method failed: {e}")
    ...
    def get_files_recursively(self, folder_path="/", max_depth=5, current_depth=0):
        ...
        try:
            if current_depth >= max_depth:
                print(f"⚠️ Max depth reached at {folder_path}")
                return []
    ...
    def _add_to_cache(self, cache_key, content):
        ...
        if len(self.file_cache) >= self.cache_max_size:
            ...
            print(f"🗑️  Removed from cache: {oldest_key}")
            ...
            for i, item in enumerate(selected_items, 1):
                ...
                if item['type'] == 'file':
                    ...
                    if content and not content.startswith("Error"):
                        ...
                        print(f"⚠️ Could not process file: {item['name']}")
                    ...
                    for j, file_data in enumerate(folder_files[:5], 1):
                        ...
                        if content and not content.startswith("Error"):
                            ...
                            print(f"  ⚠️ Could not process folder file: {file_data['name']}")
                    ...
                    if folder_contents:
                        ...
                        print(f"⚠️ No content could be read from folder: {item['name']}")
        ...
        try:
            ...
            for i, file_data in enumerate(files):
                ...
                if content and not content.startswith("Error"):
                    ...
                    print(f"⚠️ Could not process: {file_data['name']}")
